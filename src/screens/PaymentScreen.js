  ...
  return (
    <Layout style={[styles.container, {backgroundColor}]}>
      ...
      <Card style={[styles.card, {backgroundColor: cardBackgroundColor}]}>
        <Text category="h2" style={[styles.cardTitle, {color: textColor}]}>
          {t('sevenDays')}
        </Text>
        <Text category="h2" style={[styles.cardPrice, {color: textColor}]}>
          £9.99
        </Text>
        <Text category="s1" style={[styles.cardInfo, {color: textColor}]}>
          {t('accessForSevenDays')}
        </Text>
        <Button
          style={styles.button}
